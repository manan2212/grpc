...
grpc_dpop_credentials_create_type grpc_dpop_credentials_create_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_dpop_credentials_create_import = (grpc_dpop_credentials_create_type) GetProcAddress(library, "grpc_dpop_credentials_create");
